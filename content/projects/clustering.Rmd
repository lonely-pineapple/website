---
title: "Clustering, linear regression and logistic regression"
...
```{r sse within cluster by number of cluster, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, cache = TRUE}
...
```{r examine the centers, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, cache = TRUE}
