---
title: "Decision tree, KNN and text-mining"
...
I performed this analysis on a dataset containing information about borrowers of the [Lending Club](https://www.lendingclub.com/). This analysis was done during the elective "Data Mining for Business Intelligence" at [London Business School](https://www.london.edu/) taught by [Prof. Nicos Savva](https://www.london.edu/faculty-and-research/faculty-profiles/s/savva-n), [Prof. Kostis Christodoulou](https://www.london.edu/faculty-and-research/faculty-profiles/k/kostis-christodoulou) and [Prof. Ekaterina Abramova](https://www.london.edu/faculty-and-research/faculty-profiles/e/ekaterina-abramova).

![lending_club_1](https://www.hadrienpistre.com/lending_club_1.jpg)
*Image source: https://www.pymnts.com/earnings/2021/lendingclub-q2-loan-originations-soar-by-84-pct/*
...
# 0. Retrieve linear regression from workshop 2

```{r data formatting for linear regression, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, cache = TRUE}

#we format the data to run the linear regression model we determined in workshop 1
...
```{r random tree, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, cache = TRUE}
...
```{r knn, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, cache = TRUE}
...
## 3.1. Data formatting, tokenization and principal components determination
...
## 3.2. Logistic regression using principal components
...
## 3.3. Data formatting for global logistic regression (all variables + text)
...
## 3.4. Comparison of logistic regression with and without the principal componentss
